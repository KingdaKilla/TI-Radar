      ...
      case "publication":
        return (
          <PublicationPanel
            ...
            onDetailClick={detail}
            queryTimeSeconds={qts}
            // MIN-11: Header-Projektzähler (UC1) durchreichen, damit die
            // explizite "Pub/Projekt × Projekte ≈ Publikationen"-Zeile
            // dieselbe Bezugsgröße verwendet wie der Header.
            projectsCount={data.landscape?.total_projects}
            // MAJ-7/MAJ-8: Auch UC13 zeigt jetzt den Hinweis "Daten ggf.
            // unvollständig" wie UC1 und UC2, falls die Pub-Trend-Daten
            // über das letzte vollständige Jahr hinausgehen.
            dataCompleteYear={dataCompleteYear}
          />
        );
      case "geographic":
