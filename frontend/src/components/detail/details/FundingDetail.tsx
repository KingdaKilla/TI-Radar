...
const PROGRAM_DESCRIPTIONS: Record<string, string> = {
  // Funding instruments (funding_scheme from CORDIS)
  ...
  "ERC-POC": "ERC Proof of Concept — Kommerzialisierung von ERC-Ergebnissen",
  "ERC": "European Research Council — Exzellenzförderung",
  ...
  "MSCA-ITN": "Innovative Training Networks — Strukturierte Doktorandenausbildung",
  "MSCA-IF": "Individual Fellowships — Postdoc-Mobilität (H2020)",
  "MSCA-RISE": "Research & Innovation Staff Exchange — Wissenstransfer",
  "MSCA-COFUND": "Co-Funding von Programmen — Kofinanzierte Doktorandenprogramme",
  "MSCA": "Marie Skłodowska-Curie Actions — Forschermobilität",
  ...
  "SME-1": "KMU-Instrument Phase 1 — Machbarkeitsstudie (H2020)",
  "SME-2": "KMU-Instrument Phase 2 — Markteinführung (H2020)",
  "INFRAEOSC": "Europäische Open Science Cloud Infrastruktur",
  "DIGITAL-SIMPLE": "Digitale Infrastruktur und Technologien",
  "BSG-SME": "Research for SMEs — Forschung für KMU (FP7)",
  "CP-FP": "Collaborative Project — Verbundforschungsprojekt (FP7)",
  "CP-IP": "Collaborative Project (large) — Integriertes Großprojekt (FP7)",
  "CP": "Collaborative Project — Verbundforschung (FP7)",
  "NOE": "Network of Excellence — Exzellenz-Netzwerk (FP7)",
  "CP-CSA": "Coordination & Support Action — Koordinierung (FP7)",
  // Framework programmes (framework field from CORDIS)
  "FP7": "7. Forschungsrahmenprogramm der EU (2007–2013)",
  "H2020": "Horizon 2020 — EU-Rahmenprogramm für Forschung und Innovation (2014–2020)",
  "HORIZON": "Horizon Europe — EU-Rahmenprogramm für Forschung und Innovation (2021–2027)",
  "HORIZON EUROPE": "Horizon Europe — EU-Rahmenprogramm für Forschung und Innovation (2021–2027)",
  "HORIZON-ERC": "European Research Council Grants (Horizon Europe)",
  "HORIZON-MSCA": "Marie Skłodowska-Curie Actions (Horizon Europe)",
  "HORIZON-EIC": "European Innovation Council (Horizon Europe)",
  "HORIZON-CL1": "Horizon Europe — Cluster 1: Gesundheit",
  "HORIZON-CL2": "Horizon Europe — Cluster 2: Kultur, Kreativität und inklusive Gesellschaft",
  "HORIZON-CL3": "Horizon Europe — Cluster 3: Zivile Sicherheit",
  "HORIZON-CL4": "Horizon Europe — Cluster 4: Digitales, Industrie und Weltraum",
  "HORIZON-CL5": "Horizon Europe — Cluster 5: Klima, Energie und Mobilität",
  "HORIZON-CL6": "Horizon Europe — Cluster 6: Lebensmittel, Bioökonomie und Umwelt",
  "HORIZON-INFRA": "Horizon Europe — Forschungsinfrastrukturen",
  "HORIZON-WIDERA": "Horizon Europe — Beteiligung ausweiten und ERA stärken",
};
